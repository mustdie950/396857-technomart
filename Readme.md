...
* Студент: [Алексей Хохлов](https://up.htmlacademy.ru/htmlcss/18/user/396857).
* Наставник: `Кексобот`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/396857-technomart) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
